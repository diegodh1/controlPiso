...
public class dpidocitemoldcumplido {
    private String item="";
    private int cant=0;
    ...
    public dpidocitemoldcumplido() {
    }
    
    
        public dpidocitemoldcumplido(String item, int cant, String estante, String canasta, String ubica,
                          String unidad, String peso,  String val_id, String embala, String cumplido) {
        this.item = item.trim();
        this.cant = cant;
        ...
        public String toString() {
           return "{\"cant\":" + cant + ",\"val_id\":\"" + val_id +
                   ...
                   "\",\"pesotot\":\"" + pesotot + "\",\"cumplido\":\"" + cumplido + 
                   "\", \"embala\":\"" + embala + "\"}";
       }
    ...
    /**
     * @param item the cumplido to set
     */
